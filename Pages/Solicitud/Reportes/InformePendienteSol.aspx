<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ComunesWeb/menu.Master" CodeBehind="InformePendienteSol.aspx.vb" Inherits="TranscoldPruebasWeb2.InformePendienteSol" %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        <asp:ListBox ID="listOpciones" runat="server" CssClass="multi-select form-control" name="states[]" multiple="multiple" SelectionMode="Multiple">
                                            ...
                                            <asp:ListItem Selected="True">Comentarios</asp:ListItem>
                                            <asp:ListItem Selected="True">Archivos</asp:ListItem>
                                        </asp:ListBox>
